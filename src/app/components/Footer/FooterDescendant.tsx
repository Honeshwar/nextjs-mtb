...
export default function FooterWrapperDescendant({
  lang,
  base64,
}: {
  lang: string;
  ...
  return (
    <DelayContextProvider>
      <FooterDescendant lang={lang} base64={base64} />
    </DelayContextProvider>
  );
}

function FooterDescendant({ lang, base64 }: { lang: string; base64: string }) {
        ...
        <>
              ...
              <div className="col-md-3 px-0" style={{ zIndex: "99999" }}>
                <div className="w-100 ">
                  <Image
                    ...
                    alt="logo"
                    placeholder="blur"
                    blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAQAAAADCAYAAAC09K7GAAAACXBIWXMAAA7DAAAOwwHHb6hkAAAAPklEQVR4nAEzAMz/AK2RghIAAAAA2vrtle/37agAtIxxitSjhO3z3cr///nv1AD/+a8O/8ybtP/Dnqzv1bx3+ugg7TmfYBAAAAAASUVORK5CYII="
                  />
                </div>
              </div>
              <div
            ...
            >
              ...
              <div className="col-4 pt-5">
                <p className="footer_text">
                  Copyright © 2024 PhirEkBaarModiSarkar
                </p>
              </div>
          ...
          <div className="d-md-none d-block">
            ...
            >
              ...
              <p className="footer_text">
                Copyright © 2023 PhirEkBaarModiSarkar
              </p>
              <p>
                <a href="#top">
                  {" "}
